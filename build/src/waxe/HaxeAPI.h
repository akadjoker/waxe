...
float Val2Float(value inVal, float inDefault=0);
...
inline bool ValueToWX(value inValue, float &outInt)
{
   outInt = ValueToFloat(inValue);// static_cast<float>(val_get_double(value));
   return true;
}
